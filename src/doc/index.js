...
import _DataDictionary from './DataModel/Data_Dictionary';
import _ERDiagram from './DataModel/ER_Diagram';
import _Normalized from './DataModel/Normalized';
import _RelationSchema from './DataModel/Relation_Schema';

import _DemandAnalysis from './DemandAnalysis';
import _Fact_FindingTechnics from './DemandAnalysis/Fact-Finding_Technics';
import _SystemRequirementSpecification from './DemandAnalysis/System_Requirement_Specification';

import _Home from './Home';

import _InputDesign from './Input_Design';

import _OutputDesign from './Output_Design';

import _ProblemDetermination from './ProblemDetermination';
import _FeasibilityStudy from './ProblemDetermination/Feasibility_Study';
import _Fishbone from './ProblemDetermination/Fishbone';
import _ProjectSchedule from './ProblemDetermination/Project_Schedule';
import _SystemRequest from './ProblemDetermination/System_Request';
import _SystemScopeDocument from './ProblemDetermination/System_Scope_Document';

import _ProcessModeling from './ProcessModeling';
import _ContextDiagram from './ProcessModeling/Context_Diagram';
import _DFDDiagram from './ProcessModeling/DFD_Diagram';
